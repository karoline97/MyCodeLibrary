...
/* 使用方法
* FooterView footerView = new FooterView(this.getContext());
        refreshLayout.setFooterView(footerView.getFooterView());
...
public void onPushEnable(boolean enable) {
        footerView.setText(enable ? "松开加载" : "上拉加载");
        }
        });*/
