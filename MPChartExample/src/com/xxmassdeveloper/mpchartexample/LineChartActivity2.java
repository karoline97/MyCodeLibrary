...
//        l.setYOffset(11f);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.actionToggleValues) {
            ...
            mChart.invalidate();
        } else if (i == R.id.actionToggleHighlight) {
            if (mChart.getData() != null) {
                mChart.getData().setHighlightEnabled(!mChart.getData().isHighlightEnabled());
                mChart.invalidate();
            }
        } else if (i == R.id.actionToggleFilled) {
            List<ILineDataSet> sets = mChart.getData()
                    .getDataSets();
            for (ILineDataSet iSet : sets) {
            ...
            mChart.invalidate();
        } else if (i == R.id.actionToggleCircles) {
            List<ILineDataSet> sets = mChart.getData()
                    .getDataSets();
            for (ILineDataSet iSet : sets) {
            ...
            mChart.invalidate();
        } else if (i == R.id.actionToggleCubic) {
            List<ILineDataSet> sets = mChart.getData()
                    .getDataSets();
            for (ILineDataSet iSet : sets) {
            ...
            mChart.invalidate();
        } else if (i == R.id.actionToggleStepped) {
            List<ILineDataSet> sets = mChart.getData()
                    .getDataSets();
            for (ILineDataSet iSet : sets) {
            ...
            mChart.invalidate();
        } else if (i == R.id.actionToggleHorizontalCubic) {
            List<ILineDataSet> sets = mChart.getData()
                    .getDataSets();
            for (ILineDataSet iSet : sets) {
            ...
            mChart.invalidate();
        } else if (i == R.id.actionTogglePinch) {
            if (mChart.isPinchZoomEnabled())
                mChart.setPinchZoom(false);
            else
                mChart.setPinchZoom(true);
            mChart.invalidate();
        } else if (i == R.id.actionToggleAutoScaleMinMax) {
            mChart.setAutoScaleMinMaxEnabled(!mChart.isAutoScaleMinMaxEnabled());
            mChart.notifyDataSetChanged();
        } else if (i == R.id.animateX) {
            mChart.animateX(3000);
        } else if (i == R.id.animateY) {
            mChart.animateY(3000);
        } else if (i == R.id.animateXY) {
            mChart.animateXY(3000, 3000);
        } else if (i == R.id.actionSave) {
